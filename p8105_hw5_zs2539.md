...
<img src="p8105_hw5_zs2539_files/figure-gfm/unnamed-chunk-11-1.png" width="90%" />

-   As the true mean increases from 0 to 6, the proportion of times the
    null hypothesis is rejected increases accordingly (from 0.051 until
...
<img src="p8105_hw5_zs2539_files/figure-gfm/unnamed-chunk-12-2.png" width="90%" />
...
-   For the total samples, the average estimated mean $\hat{\mu}$ is
    ...
    mean $\mu$ when the true mean $\mu$ is close to 0 ($\mu$\<3).
...
true means $\mu$ are simulated, larger detectable effects were obtained,
i.e. a rise in statistical power, resulting in a boost concerning
correctness of rejecting the null,
